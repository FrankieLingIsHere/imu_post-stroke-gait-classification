...
export default function ReviewImport({onOpen}:{onOpen:(id:string)=>void}) {
  ...
  return <Card><Text style={ui.label}>Review an exported recording</Text><Body muted>Open a JSON file from the Android app. It stays in this browser tab and is cleared when you refresh. No upload.</Body>
