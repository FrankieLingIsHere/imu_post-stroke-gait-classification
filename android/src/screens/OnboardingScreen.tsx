...
const steps = [
  ...
  ['Secure your phone', 'Place it upright at your lower back, screen facing out, in a firm belt pouch. Ask someone to help if needed. Do not hold it while walking.'],
...
const imageDescriptions = ['An older adult with a walking aid and nearby helper in a clear hallway.', 'A helper secures an upright phone in a pouch at the centre of the lower back, screen facing outward.', 'Walking comfortably with the phone secured at the lower back, eyes ahead.', 'Seated safely after walking, reviewing a recording on the phone.'];
export default function OnboardingScreen({ navigation }: NativeStackScreenProps<RootStackParamList, 'Onboarding'>) {
  ...
  </>}><Image source={illustrations[step]} resizeMode="contain" accessibilityLabel={t(imageDescriptions[step])} style={{ width: '100%', height: Math.max(110, Math.min(230, height - 490 - Math.max(0, fontScale - 1) * 130)), borderRadius: 18 }} />
